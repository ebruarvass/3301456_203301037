...
class sehriyeCorbasi extends StatefulWidget {
  const sehriyeCorbasi({Key? key}) : super(key: key);

  @override
  State<sehriyeCorbasi> createState() => _sehriyeCorbasiState();
}

class _sehriyeCorbasiState extends State<sehriyeCorbasi> {
  @override
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                        image: AssetImage(
                            "images/WhatsApp Image 2022-04-06 at 21.32.17.jpeg"),
                        fit: BoxFit.cover,
                      ),
                      border: Border.all(
